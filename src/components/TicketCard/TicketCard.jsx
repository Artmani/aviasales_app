  ...
  return (
    <div className={styles.ticket}>
      <div className={styles.header}>
        ...
        <img src={`//pics.avs.io/99/36/${carrier}.png`} alt={`${carrier} Airlines`} className={styles.carrier} />
      </div>
        ...
        {segments.map((segment) => (
          <div key={segment.id} className={styles.segment}>
            <div className={styles.column}>
              ...
              <span className={styles.value}>{getTimeRange(segment.date, segment.duration)}</span>
            </div>
            <div className={styles.column}>
              <span className={styles.label}>В ПУТИ</span>
              <span className={styles.value}>{formatDuration(segment.duration)}</span>
            </div>
            <div className={styles.column}>
